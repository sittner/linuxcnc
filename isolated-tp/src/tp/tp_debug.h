...
#include "tp_rtapi_interface.h"  /* TP print functions */

/** TP debug stuff */
#ifdef TP_DEBUG
//Kludge because I didn't know any better at the time
//FIXME replace these with better names?
#define tp_debug_print(...) TP_PRINT(__VA_ARGS__)
...
#ifdef TC_DEBUG
#define tc_debug_print(...) TP_PRINT(__VA_ARGS__)
#else
...
#define tp_posemath_debug(...) TP_PRINT(__VA_ARGS__)
#else
...
#define tp_info_print(...) TP_PRINT(__VA_ARGS__)
#else

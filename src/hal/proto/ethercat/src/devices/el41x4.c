...
static const lcec_pindesc_t slave_pins[] = {
  { GOMC_HAL_FLOAT, GOMC_HAL_IO, offsetof(lcec_el41x4_chan_t, scale), "%s.%s.%s.aout-%d-scale" },
  { GOMC_HAL_FLOAT, GOMC_HAL_IO, offsetof(lcec_el41x4_chan_t, offset), "%s.%s.%s.aout-%d-offset" },
  { GOMC_HAL_FLOAT, GOMC_HAL_IO, offsetof(lcec_el41x4_chan_t, min_dc), "%s.%s.%s.aout-%d-min-dc" },
  { GOMC_HAL_FLOAT, GOMC_HAL_IO, offsetof(lcec_el41x4_chan_t, max_dc), "%s.%s.%s.aout-%d-max-dc" },
  { GOMC_HAL_FLOAT, GOMC_HAL_OUT, offsetof(lcec_el41x4_chan_t, curr_dc), "%s.%s.%s.aout-%d-curr-dc" },
  { GOMC_HAL_BIT, GOMC_HAL_IN, offsetof(lcec_el41x4_chan_t, enable), "%s.%s.%s.aout-%d-enable" },
  { GOMC_HAL_BIT, GOMC_HAL_IN, offsetof(lcec_el41x4_chan_t, absmode), "%s.%s.%s.aout-%d-absmode" },
  { GOMC_HAL_FLOAT, GOMC_HAL_IN, offsetof(lcec_el41x4_chan_t, value), "%s.%s.%s.aout-%d-value" },
  { GOMC_HAL_S32, GOMC_HAL_OUT, offsetof(lcec_el41x4_chan_t, raw_val), "%s.%s.%s.aout-%d-raw" },
  { GOMC_HAL_BIT, GOMC_HAL_OUT, offsetof(lcec_el41x4_chan_t, pos), "%s.%s.%s.aout-%d-pos" },
  { GOMC_HAL_BIT, GOMC_HAL_OUT, offsetof(lcec_el41x4_chan_t, neg), "%s.%s.%s.aout-%d-neg" },
...
int lcec_el41x4_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t **pdo_entry_regs) {
  ...
  // alloc hal memory
  if ((hal_data = env->hal->malloc(env->hal->ctx, sizeof(lcec_el41x4_data_t))) == NULL) {

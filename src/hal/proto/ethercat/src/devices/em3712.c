...
static ec_pdo_info_t lcec_em3712_pdos_in[] = {
    {0x1A00, 9, lcec_em3712_channels[0]},
    {0x1A01, 9, lcec_em3712_channels[1]},
};

static ec_sync_info_t lcec_em3712_syncs[] = {
    {0, EC_DIR_OUTPUT, 0, NULL},
    {1, EC_DIR_INPUT,  0, NULL},
    {2, EC_DIR_OUTPUT, 0, NULL},
    {3, EC_DIR_INPUT,  2, lcec_em3712_pdos_in},
    {0xff}
};
...
int lcec_em3712_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t **pdo_entry_regs) {
  ...
  slave->sync_info = lcec_em3712_syncs;

  // initialize pins
  for (i=0; i<LCEC_EM3712_CHANS; i++) {

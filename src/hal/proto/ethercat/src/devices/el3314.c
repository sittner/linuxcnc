...
static ec_pdo_info_t lcec_el3314_pdos_in[] = {
    {0x1A00, 9, lcec_el3314_channels[0]},
    {0x1A01, 9, lcec_el3314_channels[1]},
    {0x1A02, 9, lcec_el3314_channels[2]},
    {0x1A03, 9, lcec_el3314_channels[3]}
};

static ec_sync_info_t lcec_el3314_syncs[] = {
    {0, EC_DIR_OUTPUT, 0, NULL},
    {1, EC_DIR_INPUT,  0, NULL},
    {2, EC_DIR_OUTPUT, 0, NULL},
    {3, EC_DIR_INPUT,  4, lcec_el3314_pdos_in},
    {0xff}
};
...
int lcec_el3314_init(int comp_id, struct lcec_slave *slave, ec_pdo_entry_reg_t **pdo_entry_regs) {
  ...
  slave->sync_info = lcec_el3314_syncs;

  // initialize pins
  for (i=0; i<LCEC_EL3314_CHANS; i++) {

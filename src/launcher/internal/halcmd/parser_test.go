...
func TestParseLine(t *testing.T) {
	...
	dispatchTests := []struct {
		...
		{[]string{"loadrt", "mod"}, "*halcmd.LoadRTToken"},
		{[]string{"loadusr", "prog"}, "*halcmd.LoadUSRToken"},
		{[]string{"net", "sig"}, "*halcmd.NetToken"},
		{[]string{"setp", "a", "b"}, "*halcmd.SetPToken"},
		{[]string{"sets", "a", "b"}, "*halcmd.SetSToken"},
		{[]string{"getp", "a"}, "*halcmd.GetPToken"},
		{[]string{"gets", "a"}, "*halcmd.GetSToken"},
		{[]string{"addf", "f", "t"}, "*halcmd.AddFToken"},
		{[]string{"delf", "f", "t"}, "*halcmd.DelFToken"},
		{[]string{"newsig", "s", "bit"}, "*halcmd.NewSigToken"},
		{[]string{"delsig", "s"}, "*halcmd.DelSigToken"},
		{[]string{"linkps", "p", "s"}, "*halcmd.LinkPSToken"},
		{[]string{"linksp", "s", "p"}, "*halcmd.LinkSPToken"},
		{[]string{"linkpp", "p1", "p2"}, "*halcmd.LinkPPToken"},
		{[]string{"unlinkp", "p"}, "*halcmd.UnlinkPToken"},
		{[]string{"alias", "pin", "n", "a"}, "*halcmd.AliasToken"},
		{[]string{"unalias", "pin", "n"}, "*halcmd.UnAliasToken"},
		{[]string{"start"}, "*halcmd.StartToken"},
		{[]string{"stop"}, "*halcmd.StopToken"},
		{[]string{"lock"}, "*halcmd.LockToken"},
		{[]string{"unlock"}, "*halcmd.UnlockToken"},
		{[]string{"unloadrt", "c"}, "*halcmd.UnloadRTToken"},
		{[]string{"unloadusr", "c"}, "*halcmd.UnloadUSRToken"},
		{[]string{"unload", "c"}, "*halcmd.UnloadToken"},
		{[]string{"waitusr", "c"}, "*halcmd.WaitUSRToken"},
		{[]string{"list", "pin"}, "*halcmd.ListToken"},
		{[]string{"show"}, "*halcmd.ShowToken"},
		{[]string{"save"}, "*halcmd.SaveToken"},
		{[]string{"status"}, "*halcmd.StatusToken"},
		{[]string{"debug", "0"}, "*halcmd.DebugToken"},
		{[]string{"ptype", "n"}, "*halcmd.PTypeToken"},
		{[]string{"stype", "n"}, "*halcmd.STypeToken"},
		{[]string{"echo"}, "*halcmd.EchoToken"},
		{[]string{"unecho"}, "*halcmd.UnEchoToken"},
		{[]string{"print", "msg"}, "*halcmd.PrintToken"},
	}

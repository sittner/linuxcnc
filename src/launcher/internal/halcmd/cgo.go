...
/*
#cgo CFLAGS: -I${SRCDIR}/../../../hal -I${SRCDIR}/../../.. -I${SRCDIR}/../../../rtapi -I${SRCDIR}/../../../../include -DULAPI
...
return &hal.Error{Op: op, Message: message, Code: code}
}
...
// listShimFn is a function type for the hal_shim_list_* family.
